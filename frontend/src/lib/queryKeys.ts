...
export const QK = {
  ...
  holdingsAccounts:       ['holdings-accounts'] as const,
  holdingsPnlDay:          (day: string, acc?: string) => ['holdings-pnl-day', day, acc] as const,
  holdingsTzzbHistoryData: ['holdings-tzzb-history-data'] as const,
  holdingsTzzbMonthlyStats: ['holdings-tzzb-monthly-stats'] as const,
  holdingsTzzbReports:     ['holdings-tzzb-reports'] as const,
  holdingsSparklines:      (acc?: string) => ['holdings-sparklines', acc] as const,
  holdingsTargets:         (acc?: string) => ['holdings-targets', acc] as const,
  holdingsBenchmark:       (year: number, acc?: string) => ['holdings-benchmark', year, acc] as const,
  holdingsSettings:        ['holdings-settings'] as const,
  holdingsSummaryBase:     ['holdings-summary-base'] as const,
  holdingsTzzbHistory:     ['holdings-tzzb-history'] as const,
